# Data Model: HSME V1 Remediation

## Entities (No Schema Changes, Only Trigger Removal)
...
- **CRITICAL CHANGE**: Removal of `AFTER INSERT`, `AFTER UPDATE`, `AFTER DELETE` triggers associated with this table. Synchronization happens exclusively in `src/core/indexer/ingest.go`.
